...
This script trains an ExtraTrees Regressor model on the m2 worsening dataset
to predict the duration based on input features. It includes
...
def plot_feature_importance(model, feature_names, model_name, top_n=15, X_train=None, y_train=None):
    ...
    if hasattr(model, 'feature_importances_'):
        ...
        plt.tight_layout()
        plt.savefig(f"viz/regression_results/rg_feature_importance_m2.png", 
                   dpi=300, bbox_inches='tight', facecolor='white')
        plt.close()
        
        print(f"Saved enhanced feature importance plot with confidence intervals to viz/regression_results/rg_feature_importance_m2.png")
...
def plot_true_vs_pred(y_true, y_pred, model_name="Model", save_path="viz/regression_results/rg_true_vs_pred_m2.png"):
    ...
    plt.xlabel("True Duration (365 days)")
    plt.ylabel("Predicted Duration (365 days)")
...
def main():
    ...
    # File path
    file_path = "./processed/worsening_m2.csv"
    ...
    test_csv_path = "./processed/RG_m2_test.csv"
    ...
    model_path = os.path.join("models", "rg_m2_model.joblib")
